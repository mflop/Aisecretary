  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Bun venit, Utilizator</h2>
          <p className="text-muted-foreground">
            Iată un rezumat al activității companiei tale
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 text-muted-foreground"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">0</div>
            <p className="text-xs text-muted-foreground">
              0 mesaje AI luna aceasta
            </p>
          </CardContent>
        </Card>
        <Card>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          ...
          <CardContent>
            <div className="text-center py-10 text-muted-foreground">
              <p>Adaugă clienți și programări pentru a vedea activitatea lor aici.</p>
              <div className="mt-4">
                <Link href="/dashboard/clients/new">
        ...
        <Card className="col-span-3">
          ...
          <CardContent>
            <div className="text-center py-10 text-muted-foreground">
              <p>Adaugă programări pentru a le vedea aici.</p>
              <div className="mt-4">
